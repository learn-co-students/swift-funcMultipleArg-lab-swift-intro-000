 ...
 */
func countriesInTheContinent(nameOfContinent: String, numberOfCountries: Int) {
    
    print("\(nameOfContinent) is a continent which contains \(numberOfCountries) countries.")
}

countriesInTheContinent(nameOfContinent: "Africa", numberOfCountries: 30)
 ...
 */
func beerSong(number: Int, beverage: String, place: String) {
    
    print("\(number) bottles of \(beverage) on the \(place) wall.")
}

beerSong(number: 29, beverage: "beer", place: "Stone")
