 ...
 */
func countriesInTheContinent(continentName: String, numberOfCountries: Int) {
    
    print("\(continentName) is a continent which contains \(numberOfCountries) countries.")
}

countriesInTheContinent(continentName: "Africa", numberOfCountries: 54)
 ...
 */
func drinkSong(number: Int, beverage: String, place: String) {
    
    print("\(number) bottles of \(beverage) on the \(place) wall.")
    
}

drinkSong(number: 29, beverage: "wine", place: "rack on the")
