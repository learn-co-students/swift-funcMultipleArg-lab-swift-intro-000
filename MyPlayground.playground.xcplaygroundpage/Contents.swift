...
func numOfCounties(continent: String, number: Int) {
    print("\(continent) is a continent which contains \(number) countries")
}

numOfCounties(continent: "North America", number: 4)
 ...
 */
// write your code here
func bottlesOfBeer(number: Int, beverage: String, wall: String) {
    print("\(number) bottles of \(beverage) on the \(wall).")
}

bottlesOfBeer(number: 75,beverage: "beer",wall: "bar")
