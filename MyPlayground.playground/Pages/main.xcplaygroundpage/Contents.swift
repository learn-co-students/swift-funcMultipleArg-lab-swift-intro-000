 ...
 */
func numberOfCountries(continent: String, number: String) {
    print("\(continent) is a continent which contains \(number) countries.")
}
numberOfCountries(continent: "Africa", number: "Fifty-four")
 ...
 */
func bottlesOfBeer(number: Int, beverage: String, place: String) {
    print("\(number) bottles of \(beverage) on the \(place) wall.")
}
bottlesOfBeer(number: 99, beverage: "beer", place: "kitchen")
