 ...
 */
func countriesIn (continent: String, withCountries number: Int) {
 ...
 */
func whatToDrink (numberOfBottles: Int, typeOfBeverage: String, place: String) {
    
    print("\(numberOfBottles) bottles of \(typeOfBeverage) on the \(place) wall.")
}
