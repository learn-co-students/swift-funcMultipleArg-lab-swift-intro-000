...
func numbers(of countries: Int, within continent: String) {
    print("\(continent) is a continent which contains \(countries) countries.")
}

numbers(of: 10, within: "America")
...
daysInMonth(month: "November", days: "thirty")
 ...
 */
// write your code here
func beverageDetail(of beverage: String, withNumber number: Int, inPlace place: String) {
    print("\(number) bottles of \(beverage) on the \(place) wall.")
}

beverageDetail(of: "Coke", withNumber: 10, inPlace: "Fridge")
