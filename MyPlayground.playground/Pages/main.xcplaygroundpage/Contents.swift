 ...
 */
func howManyCountries(_ continent: String, _ countries: Int){
    print("\(continent) is a continent which contains \(countries) countries")
}

howManyCountries("Asia", 27)

//or

func howManyCount(continent: String, countries: Int){
    print("\(continent) is a continent which contains \(countries) countries")
}

howManyCount(continent: "North America", countries: 3)
 ...
 */
func threeArgs(_ beverage: String, _ number: Int, _ place: String){
    print("\(number) bottles of \(beverage) on the \(place) wall")
}

threeArgs("Beer", 99, "front")
