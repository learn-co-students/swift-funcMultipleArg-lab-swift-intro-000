 ...
 */
func countriesInContenent(continent: String, countries: Int) {
 ...
 */
func bottlesOnTheWall(numberOfBottles: Int, beverageType: String, place: String) {
  print("\(numberOfBottles) bottles of \(beverageType) on the \(place).")
}

bottlesOnTheWall(numberOfBottles: 99, beverageType: "beer", place: "wall")
