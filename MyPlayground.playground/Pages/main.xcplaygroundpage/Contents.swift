...
countriesInContinent(continent: "Asia", numberOfCountries: 48)
/*: question2
...
func awesomeDrinks(beverage: String, numberOfBottles: Int, storageLocation: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(storageLocation) wall.")
}

awesomeDrinks(beverage: "Vodka", numberOfBottles: 405, storageLocation: "blue")
