...
func continentFunc(continent: String, country: Int) {
    print("\(continent) is a continent which contains \(country) countries.")
}
continentFunc(continent: "Australia", country: 1)
 ...
 */
// write your code here
func wineFunc(beverage: String, bottles: Int, place: Int) {
    print("\(bottles) bottles of \(beverage) on the \(place) wall.")
}
wineFunc(beverage: "Chianti", bottles: 2, place: 5)
