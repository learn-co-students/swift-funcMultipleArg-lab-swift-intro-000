...
continentsAndCountries(continent: "north america", countries: 3)
 ...
 */
// write your code here
func drinks(beverage: String, numberOfBottles: Int, storage: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(storage)")
    
}


drinks(beverage: "coffee", numberOfBottles: 4, storage: "kitchen table")
