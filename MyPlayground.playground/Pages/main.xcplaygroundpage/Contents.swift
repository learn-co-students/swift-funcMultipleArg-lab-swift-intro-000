...
func atlasThing(continentName: String, numberOfCountries: Int){
 ...
 */
// write your code here
func carSong(beverageType: String, numberOfBottles: Int, bottleLocation: String){
    print("\(numberOfBottles) bottles of \(beverageType) on the \(bottleLocation)")
}

carSong(beverageType: "Beer", numberOfBottles: 100, bottleLocation: "Bathroom")
