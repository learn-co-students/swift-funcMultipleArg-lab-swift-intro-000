...
func printContinentCountries(continent:String,numberCountries:Int){
 ...
 */
// write your code here
func printBottle(beverage:String, bottleNum: Int, place: String){
    print("\(bottleNum) bottles of \(beverage) on the \(place)")
}

printBottle(beverage: "Beer", bottleNum: 5, place: "West")
