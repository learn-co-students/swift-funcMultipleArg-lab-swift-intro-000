 ...
 */
func countCount(continent: String, countries: Int) {
...
func beerSong(num: Int, drink: String, swear: String) {
    print ("\(num) bottles of \(drink) on the \(swear) wall.")
}

beerSong(num: 99, drink: "beer", swear: "fucking")
