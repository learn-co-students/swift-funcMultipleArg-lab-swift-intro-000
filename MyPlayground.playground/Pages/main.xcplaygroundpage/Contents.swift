 ...
 */
func printContinentAndCountries( continent: String, countries: Int ) {
    print("\(continent) is a continent which contains \(countries) countries.")
}

printContinentAndCountries(continent: "Australia", countries: 1)
 ...
 */
func party( beverage: String, numberOfBottles: Int, place: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(place) wall.")
}

party(beverage: "Whisky", numberOfBottles: 99, place: "high")
