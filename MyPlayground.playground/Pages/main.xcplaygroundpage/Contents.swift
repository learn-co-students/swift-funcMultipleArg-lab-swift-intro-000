...
func randomfunction(name: String, noBottles: Int, location: String) {
    print("\(noBottles) bottles of \(name) on the \(location) wall")
}
randomfunction(name: "Coke", noBottles: 32, location: "tall")
