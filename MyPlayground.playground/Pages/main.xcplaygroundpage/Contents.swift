...
func sentenceA(continent: String, numberOfCountries: Int){
...
func beverage(bottles: String, number: Int, whereb: String){
    print("\(bottles) bottles of \(number) on the \(whereb) wall")
}

beverage(bottles: "Lol", number: 5, whereb: "Paris")
