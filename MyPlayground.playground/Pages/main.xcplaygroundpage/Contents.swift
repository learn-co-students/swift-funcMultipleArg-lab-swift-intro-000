...
func countryContinent(continent: String, countries: Int) {
...
greeting(greeting: "Hello", name: "Danny")
...
func nursery(beverage: String, number: Int, place: String){
    print("\(number) bottles of \(beverage) on the \(place) wall.")
}

nursery(beverage: "beer", number: 3, place: "back")
