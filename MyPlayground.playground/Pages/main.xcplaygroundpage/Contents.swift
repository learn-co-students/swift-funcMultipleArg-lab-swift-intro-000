...
func printSentence(continent: String, numberOfCountries: Int) {
...
printSentence(continent: continent, numberOfCountries: numCountries)
/*: question2
 ...
 */
// write your code here
func printSentence2(beverage: String, numberOfBottles: String, place: String) {
  print("\(numberOfBottles) bottles of \(beverage) on the \(place) wall.")
}

printSentence2(beverage: "Tee", numberOfBottles: "5", place: "Nice")
