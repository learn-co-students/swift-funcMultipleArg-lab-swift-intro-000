...
continentWithCountries(continent: "NorthAmerica", countries: 2)
 ...
 */
// write your code here
func sodaInventory(beverage:String,bottles:Int,storage:String) {
    print("\(bottles) bottles of \(beverage) on the \(storage) wall")
}
 sodaInventory(beverage: "coke", bottles: 35, storage: "kitchen")
