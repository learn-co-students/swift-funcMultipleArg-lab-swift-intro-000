 ...
 */
func detailsOf(continent:String, countries:Int){
    print("\(continent) is a continent which contains \(countries) countries")
}

detailsOf(continent: "nirvana", countries: 1)
/*: question2
 ...
 */
func place(beverage:String,quantity:Int, location:String){
    print("\(quantity) bottles of \(beverage) on the \(location) wall.")
}

place(beverage: "Coca Cola", quantity: 10, location: "glory")
