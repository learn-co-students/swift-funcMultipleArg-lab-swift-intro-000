...
var countries = 10
func geo(continent: String, countries: Int) {
    print("\(continent) is a continent which contains \(countries) countries")
}
geo(continent: continent, countries: countries)
 ...
 */
func party(beverage: String, quantity: Int, place: String) {
    print("\(quantity) bottles of \(beverage) on the \(place) wall")
}
party(beverage: "Pepsi", quantity: 5, place: "fridge")
