...
continentCountries(name: "North America", number: 3)
 ...
 */
func drinkNumbers(numberBottles: Int, drinkName: String, locationWall: String) {
    print("\(numberBottles) bottles of \(drinkName) on the \(locationWall) wall.")
}

drinkNumbers(numberBottles: 99, drinkName: "Big Wave beer", locationWall: "southside")
