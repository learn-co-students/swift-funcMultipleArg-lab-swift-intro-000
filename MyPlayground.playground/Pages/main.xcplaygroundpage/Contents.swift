 ...
 */
func theGlobe(continent: String, countries: Int) {
    print("\(continent) is a continent which contains \(countries) countries.")
}

theGlobe(continent: "Europe", countries: 10)
 ...
 */
func drinks(beverage: String, numBottles: Int, wall: String) {
    print("\(numBottles) bottles of \(beverage) on the \(wall) wall.")
}
...
drinks(beverage: bev, numBottles: numbot, wall: location)
