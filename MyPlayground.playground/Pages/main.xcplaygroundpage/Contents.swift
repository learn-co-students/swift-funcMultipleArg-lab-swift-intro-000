 ...
 */
func continentCount(continent: String, countries: Int) {
    print("\(continent) is a continent which contains \(countries) countries")
}

continentCount(continent: "North America", countries: 3)
/*: question2
 ...
 */
func bottleStorage(number: Int, type: String, location: String) {
    print("\(number) bottles of \(type) on the \(location)")
}

bottleStorage(number: 99, type: "beer", location: "wall")
