 ...
 */
func greeting(name: String, greetingWord: String) {
    print("\(greetingWord), \(name)!")
}

greeting(name: "Danny", greetingWord: "Hello")
 ...
 */
// write your code here
func singMeASong(number: Int, drink: String, adjective: String){
    print("\(number) bottles of \(drink) on the \(adjective) wall.")
}

singMeASong(number: 99, drink: "beer", adjective: "")
