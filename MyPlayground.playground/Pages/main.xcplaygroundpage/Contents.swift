 ...
 */
func theContinent(continent: String, noCountries: Int) {
    print("\(continent) is a continent which contains \(noCountries) countries.")
}

theContinent(continent: "North America", noCountries: 3)
 ...
 */
func howMany(number: Int, type: String, direction: String) {
    print("\(number) bottles of \(type) on the \(direction) wall.")
}

howMany(number: 40, type: "beer", direction: "south")
