...
firstFunction(continent: "North America", numberOfCountries: 2)
 ...
 */
// write your code here
func bottlesRhyme(beverage: String, numberOfBottles: Int, place: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(place).")
}
bottlesRhyme(beverage: "beer", numberOfBottles: 99, place: "wall")
