 ...
 */
func songLyrics(beverage: String, numberOfBottles: Int, location: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(location) wall.")
}

let beverage = "beer"
let numBottles = 99
let location = "westernmost"

songLyrics(beverage: beverage, numberOfBottles: numBottles, location: location)
