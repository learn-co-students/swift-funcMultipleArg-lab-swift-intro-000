...
func printCountriesInCont(continent: String, numberOfCountries: Int) {
    print("\(continent) is a continent which contains \(numberOfCountries) countries")
}

printCountriesInCont(continent: "Asia", numberOfCountries: 100)
/*: question2
 ...
 */
// write your code here
func bottlesOnWall(beverage: String, numberOfBottles: Int, place: String){
    print("\(numberOfBottles) bottles of \(beverage) on the \(place) wall")
}

bottlesOnWall(beverage: "Sprite", numberOfBottles: 5, place: "club")
