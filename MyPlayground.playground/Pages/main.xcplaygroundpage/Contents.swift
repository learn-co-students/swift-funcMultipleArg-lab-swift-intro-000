...
var cont = "Europe"
var number = 51
continentDescription(continent: cont, countries: number)
 ...
 */
func bottleDescription (beverage: String, bottles: Int, place: String){
...
bottleDescription(beverage: beverage, bottles: bottles, place: place)
