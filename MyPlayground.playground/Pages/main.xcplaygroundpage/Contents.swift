...
continentInfo(continent: "Euromerasia", countries: 1024)
 ...
 */
func beerOnTheWall(beverage: String, num: Int, location: String) {
    print("\(num) bottles of \(beverage) on the \(location).")
}

beerOnTheWall(beverage: "beer", num: 99, location: "wall")  
