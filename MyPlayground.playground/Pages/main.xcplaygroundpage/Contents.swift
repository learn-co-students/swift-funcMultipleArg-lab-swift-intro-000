 ...
 */
func myContinent(continent: String, countries: Int) {
    print("\(continent) is a continent which contains \(countries) countries")
}

myContinent(continent: "Africa", countries: 54)
 ...
 */
func drink(beverage: String, numberOfBottles: Int, storagePlace: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(storagePlace) wall.")
}
