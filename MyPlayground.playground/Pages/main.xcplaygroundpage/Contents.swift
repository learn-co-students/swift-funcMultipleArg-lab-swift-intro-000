...
func numCountries(continent: String, number: Int){
    print("\(continent) is a continent which contains \(number) countries.")
}

numCountries(continent: "North America", number: 3)
 ...
 */
// write your code here
func bottleCount(counter: Int, beverage: String, location: String){
    print("\(counter) bottles of \(beverage) on the \(location) wall.")
}

bottleCount(counter:99, beverage: "beer", location: "bar")
