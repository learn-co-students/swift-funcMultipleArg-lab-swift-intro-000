...
numberOfCountries(continent: "Africa", countries: 81)
 ...
 */
func bottles(numberBottles: Int, beverage: String, place: String) {
    print("\(numberBottles) bottles of \(beverage) on the \(place) wall.")
}

bottles(numberBottles: 5, beverage: "Grey Goose", place: "dank")
