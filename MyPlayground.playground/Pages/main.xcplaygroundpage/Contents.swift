 ...
 */
func one(name: String, number: Int) {
    print("\(name) is a continent which contains \(number) countries")
}

one(name: "North America", number: 4)
 ...
 */
func two(number: Int, beverage: String, place: String) {
    print("\(number) bottles of \(beverage) on the \(place) wall")
}

two(number: 14, beverage: "Whiskey", place: "TJ's House")
