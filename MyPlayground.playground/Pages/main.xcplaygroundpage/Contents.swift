...
func continent(continent: String, country: Int) {
    print("\(continent) is a continent which contains \(country) countries")
}

continent(continent: "Indonesia", country: 2000)
 ...
 */
// write your code here
func things(beverage: String, bottle: Int, place: String){
    print("\(bottle) bottles of \(beverage) on the \(place) wall")
}

things(beverage: "Coke", bottle: 5, place: "side")
