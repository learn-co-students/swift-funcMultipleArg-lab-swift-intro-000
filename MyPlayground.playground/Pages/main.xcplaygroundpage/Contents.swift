...
func countriesInContinent(continent: String, numberOfCountries: Int) {
    "\(continent) is a continent which contains \(numberOfCountries) countries."
}
...
func beverageInfo(beverage: String, numberOfBottles: Int, placeToKeepBottles: String) {
    print("\(numberOfBottles) of \(beverage) on the \(placeToKeepBottles) wall")
}
