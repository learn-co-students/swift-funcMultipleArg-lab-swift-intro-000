 ...
 */
func continentContains(continent: String, numberCountries countries: Int) {
    print("\(continent) is a continent which contains \(countries) countries.")
}


continentContains(continent: "Earth", numberCountries: 5000000)
 ...
 */
func song(beverage: String, numberBottles bottles: Int, bottleLocation location: String) {
    print("\(bottles) bottles of \(beverage) on the \(location) wall.")
}

song(beverage: "beer", numberBottles: 55, bottleLocation: "back")
