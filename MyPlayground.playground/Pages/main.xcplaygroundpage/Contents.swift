 ...
 */
func printContinent(continent: String, numOfCountries: Int) {
 ...
 */
func beerSong(numOfDrinks: Int, beverage: String, typeOfWall: String){
    print("\(numOfDrinks) bottles of \(beverage) on the \(typeOfWall) wall.")
}

beerSong(numOfDrinks: 99, beverage: "orange juice", typeOfWall: "blue")
