 ...
 */
func continentInfo(continentName: String, numberOfCountries: Int) {
 ...
 */
func bottles(names: String, quantity: Int, placement:String) {
    print("\(quantity) bottles of \(names) on the \(placement) wall")
}
bottles(names: "Ciroc", quantity: 5, placement: "Front")
