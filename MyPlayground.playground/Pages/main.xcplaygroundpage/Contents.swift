 ...
 */
func worldGeo(_ continent: String, _ countries: Int) {
 ...
 */
func bevInfo(beverage: String, numberOfBottles: Int, placeKept: String){
    print("\(numberOfBottles) bottles of \(beverage) on the \(placeKept) wall")
}

bevInfo(beverage: "Sprite", numberOfBottles: 53, placeKept: "back")
