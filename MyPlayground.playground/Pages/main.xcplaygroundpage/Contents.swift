...
continentCountries(continent: "North America", countries: 3)
 ...
 */
func bottlesOnWall(bottleName: String, numOfBottles: Int, placeOfBottle: String) {
    print("\(numOfBottles) bottles of \(bottleName) on the \(placeOfBottle) wall.")
}

bottlesOnWall(bottleName: "liquid", numOfBottles: 13, placeOfBottle: "garage")
