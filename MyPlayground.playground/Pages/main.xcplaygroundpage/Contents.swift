...
numberOfCountries(continent: "North America", number: 23)
 ...
 */
func bottlesOfBeerOnTheWall(beverage: String, numberOfBottles: Int, place: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(place) wall")
}

bottlesOfBeerOnTheWall(beverage: "beer", numberOfBottles: 99, place: "dining room")
