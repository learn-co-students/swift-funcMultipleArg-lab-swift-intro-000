...
func contientAndCountries(continent: String, numberOfCountries: Int) {
...
contientAndCountries(continent: continent, numberOfCountries: numberOfCountries)
...
threeParameters(beverage: beverage, numberOfBottles: numberOfBottles, place: place)
