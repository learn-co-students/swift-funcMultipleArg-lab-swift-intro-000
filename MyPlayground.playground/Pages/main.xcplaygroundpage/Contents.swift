 ...
 */
func myfunc(continent: String, countries: Int) {
 ...
 */
func bottles(_ bev: String, _ num: Int, _ place: String) {
    print("\(num) bottles of \(bev) on the \(place) wall.")
}

let bev = "soda"
let num = 1000000
let place = "bar"
bottles(bev, num, place)
