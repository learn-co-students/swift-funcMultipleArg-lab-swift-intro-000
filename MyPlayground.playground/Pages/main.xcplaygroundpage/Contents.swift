...
countriesInContinent(continent: "Africa", countries: 68)
 ...
 */
func fancyADrink(beverage: String, bottles: Int, place: String){
    print("\(bottles) bottles of \(beverage) on the \(place).")
}

fancyADrink(beverage: "orange", bottles: 12, place: "worktop")
