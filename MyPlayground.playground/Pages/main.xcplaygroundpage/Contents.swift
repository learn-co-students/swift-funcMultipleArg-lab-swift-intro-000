...
func countriesNumber(continent: String, countries: Int) {
    print("\(continent) is a continent which contains \(countries) countries")
}
countriesNumber(continent: "Europe", countries: 32)
 ...
 */
// write your code here
func theFridge(beverage: String, bottles: Int, place: String = "Fridge" ){
    print("\(beverage) bottles of \(bottles) on the \(place)")
}
theFridge(beverage: "coca cola", bottles: 21)
