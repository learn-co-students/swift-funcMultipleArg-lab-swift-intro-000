...
func hiContinent(continent: String, number: Int) {
    
    print("\(continent) is a continent which contains \(number) countries")
}

hiContinent(continent: "America", number: 68)
 ...
 */
// write your code here
func haveABeverage(_ beverage: String, _ number: Int, _ place: String) {
    
    print("\(number) bottles of \(beverage) on the \(place) wall.")
}

haveABeverage("Coca Cola", 6, "dining room")
