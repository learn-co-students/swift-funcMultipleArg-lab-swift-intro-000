...
describeContinent(continent: "Africa", countries: 45)
 ...
 */
func store(beverage: String, numberOfBottles: Int, place: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(place) wall.")
}

store(beverage: "Heineken", numberOfBottles: 12, place: "living room")
