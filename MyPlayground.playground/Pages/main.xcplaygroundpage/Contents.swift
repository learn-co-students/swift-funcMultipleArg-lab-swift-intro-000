...
func continentInfo(continentName name: String, numberOfCountries number: Int) {
 ...
 */
// write your code here
func beverageInfo(beverageName name: String, numberOfBottles number: Int, whereKept kept: String) {
    print("\(number) bottles of \(name) on the \(kept) wall.")
