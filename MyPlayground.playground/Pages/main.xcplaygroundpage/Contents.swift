...
continentDescription(continentName: "Africa", numberOfCountries: 54)
 ...
 */
func placeOfBottles (_ beverage: String, numberOfBottles: Int, place: String){
    
    print("\(numberOfBottles) bottles of \(beverage) on \(place) for \(beverage.lowercased())")
    
}

placeOfBottles("Vine", numberOfBottles: 3, place: "shelves")
