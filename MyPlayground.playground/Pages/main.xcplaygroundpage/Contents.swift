 ...
 */
func numberOfCountriesInContinent(_ continent: String, numberOfCountries: Int) {
 ...
 */
func storeBeverage(_ beverage: String, numberOfBottles: Int, storage: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(storage) wall.")
}

storeBeverage("passion fruit juice", numberOfBottles: 8, storage: "juicy")
