...
func PrintNunberContinentCountries(_ continent : String, _ numberOfCountries : Int){
    print("\(continent) is a continent which contains \(numberOfCountries) countries")
}
PrintNunberContinentCountries("Africa", 54)
...
func DisplayNumOfBottles(_ numberOfBottles : Int, _ bottleType : String, _ wallLocation : String){
    print("\(numberOfBottles) bottles of \(bottleType) on the \(wallLocation) wall")
}
DisplayNumOfBottles(99, "beer", "back")
