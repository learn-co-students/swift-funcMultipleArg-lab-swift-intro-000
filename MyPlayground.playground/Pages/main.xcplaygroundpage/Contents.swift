 ...
 */
func beverageDescription(beverage: String, numberOfBottles: Int, beverageLocation: String) {
    print("\(numberOfBottles) botttles of \(beverage) on the \(beverageLocation) wall.")
}


beverageDescription(beverage: "Ginger Ale", numberOfBottles: 6, beverageLocation: "Cabinet")
