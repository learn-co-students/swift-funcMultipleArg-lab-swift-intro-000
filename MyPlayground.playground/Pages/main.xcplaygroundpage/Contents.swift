 ...
 */
func world( _ continentName: String, _ numberOfCountries: String) {
 ...
 */
func bevIntake( _ beverageName: String, _ numberOfBottles: Int, _ locationOfBottles: String) {
    print("\(numberOfBottles) bottles of \(beverageName) on the \(locationOfBottles) wall")
}

bevIntake("Pepsi", 40, "shelf")
