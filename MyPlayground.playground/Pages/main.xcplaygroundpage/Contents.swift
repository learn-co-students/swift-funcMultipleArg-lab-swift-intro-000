 ...
 */
func numCountries(continent: String, num: Int){
    print("\(continent) is a continent which contains \(num) countries")
}
numCountries("Europe", num: 60)
 ...
 */
func flaskor(bev: String, numBot: Int, place: String){
print("\(numBot) bottles of \(bev) on the \(place) wall.")
}


flaskor("beer", numBot: 9, place: "kitchen")
