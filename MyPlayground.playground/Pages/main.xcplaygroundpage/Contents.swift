 ...
 */
func continents(contName: String, numCountries: Int){
    print("\(contName) is a continent which contains \(numCountries) countries.")
}

continents(contName: "Africa", numCountries: 108)
 ...
 */
func soundsLikeAParty(bev: String, numBottles: Int, storagePlace: String){
