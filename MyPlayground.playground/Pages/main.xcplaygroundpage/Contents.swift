 ...
 */
func continentDescription(_ continent: String,_ numberOfCountries: Int){
    print("\(continent) is a continent which contains \(numberOfCountries) countries")
}

continentDescription("North America", 3)
 ...
 */
func beverageCounter(_ beverage: String,_ numberOfBottles: Int,_ location: String){
    print("\(numberOfBottles) bottles of \(beverage) on the \(location) wall")
}

beverageCounter("Beer", 99, "Back")
