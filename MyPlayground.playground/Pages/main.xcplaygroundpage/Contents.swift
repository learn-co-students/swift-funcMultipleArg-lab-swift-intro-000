...
func myFunc1(continent: String, countriesCount: Int){
    print("\(continent) is a continent which contains \(countriesCount) countries.")
}
myFunc1(continent: "N. America", countriesCount: 2)
 ...
 */
// write your code here
func myBev(_ myBev: String, _ myBot: Int, _ myPlac: String ){
    print("\(myBot) bottle of \(myBev) on the \(myPlac) wall.")
}
