...
func continentCountries(continent: String, country: Int){
 ...
 */
// write your code here
func drinkKeeper(beverage: String, numBev: Int, hidingPlace: String){
    print("\(numBev) bottles of \(beverage) on the \(hidingPlace) wall.")
}
