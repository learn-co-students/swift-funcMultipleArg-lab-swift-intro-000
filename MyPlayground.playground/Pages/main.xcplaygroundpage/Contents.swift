 ...
 */
func first(continent: String, numCountries: Int) {
 ...
 */
func second(beverage: String, numBottles: Int, place: String) {
    print("\(beverage) bottles of \(numBottles) on the \(place) wall.")
}
