...
continentDescription(continent: "Asia", numberOfCountries: 20)
 ...
 */
func three(beverage: String, numberOfBottles: Int, place: String) {
...
three(beverage: beverage, numberOfBottles: num, place:place )
