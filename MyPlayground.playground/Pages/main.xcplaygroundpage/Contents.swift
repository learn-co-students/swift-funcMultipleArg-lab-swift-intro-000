...
geography(continent: "Europe", numberOfCountries: 50)
 ...
 */
func myBar(beverage: String, qty: Int, storage: String) {
    
    print("\(qty) bottles of \(beverage) on the \(storage).")
}

myBar(beverage: "wine", qty: 3, storage: "shelve")
