 ...
 */
func describeContinent(continent: String, has countries:Int) {
 ...
 */
func beerSong(beverage:String, bottleNum: Int, place: String)   {
    print("\(bottleNum) bottles of \(beverage) on the \(place) wall.")
}
beerSong(beverage: "beer", bottleNum: 99, place: "bar")
