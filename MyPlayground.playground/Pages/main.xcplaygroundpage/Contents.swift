 ...
 */
func define(continent:String, has countries: Int)
{
    print("\(continent) is a continent which contains \(countries) country/countries.")
}

define(continent:"Antarctica", has:1)
 ...
 */
func bev(_ beverage:String,_ number:Int, _ place:String)
{
