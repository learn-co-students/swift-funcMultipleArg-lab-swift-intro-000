...
numberOfCountries(continent: "Europe", countries: 27)
 ...
 */
func beverages(numberOfBottles: Int, typeOfDrink: String, storageArea: String) {
    print("\(numberOfBottles) bottles of \(typeOfDrink) on the \(storageArea) wall.")
}

beverages(numberOfBottles: 5, typeOfDrink: "Coke Zero", storageArea: "Under Stairs")
