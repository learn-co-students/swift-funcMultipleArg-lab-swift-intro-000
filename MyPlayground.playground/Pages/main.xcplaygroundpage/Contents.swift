 ...
 */
func continentPrint(continent: String, countries: Int) {
    print("\(continent) is a continent which contains \(countries) countries")
}
continentPrint(continent: "Asia", countries: 12)
 ...
 */
func bottlePrint(beverage: String, count: Int, place: String) {
    print("\(count) bottles of \(beverage) on the \(place) wall.")
}
bottlePrint(beverage: "Cola", count: 12, place: "top")
