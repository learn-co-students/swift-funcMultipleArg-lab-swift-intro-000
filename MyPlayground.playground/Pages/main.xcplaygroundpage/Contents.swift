...
func continent(continent: String, numberCountries: Int) {
 ...
 */
// write your code here
func bottlesOfRum(numberOfBottles: Int, typeOfLiquor: String, wallType: String) {
    print("\(numberOfBottles) bottles of \(typeOfLiquor) on the \(wallType) wall")
}

bottlesOfRum(numberOfBottles: 30, typeOfLiquor: "rum", wallType: "bedroom")
