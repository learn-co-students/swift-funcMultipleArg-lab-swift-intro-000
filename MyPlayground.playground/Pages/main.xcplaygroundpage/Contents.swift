 ...
 */
func Continent (cont:String,countries:Int){
    print("\(cont) is a continent which contains \(countries) countries.")
    
}

Continent(cont:"LaLa",countries:999)
 ...
 */
func Bottles(numbot:Int,liquid:String, place:String){
    print("\(numbot) bottles of \(liquid) on the \(place) wall.")
}

Bottles(numbot:99,liquid:"rum",place:"blasted")
