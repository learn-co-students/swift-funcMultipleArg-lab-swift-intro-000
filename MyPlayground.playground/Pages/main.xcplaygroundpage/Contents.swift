 ...
 */
func countryCount (continent: String, countries: Int) {
    print("\(continent) is a continent which contains \(countries) countries.")
}

countryCount(continent: "North America", countries: 23)
 ...
 */
func wallGame (bottles: Int, item: String, direction: String) {
    print("\(bottles) bottles of \(item) on the \(direction) wall.")
}

wallGame(bottles: 99, item: "beer", direction: "east")
