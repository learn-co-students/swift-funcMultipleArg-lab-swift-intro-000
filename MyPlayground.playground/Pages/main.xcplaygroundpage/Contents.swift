 ...
 */
func continent (numberOfCountries: Int, cont: String) {
 ...
 */
func beverageInBottles (beverage: String, numberOfBottles: Int, storage: String){
    print("\(numberOfBottles) bottles of \(beverage) on the \(storage) wall.")
}
beverageInBottles(beverage: "tequila", numberOfBottles: 7, storage: "kitchen")
