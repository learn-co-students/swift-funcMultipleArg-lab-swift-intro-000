...
func places(continent: String, countries: Int) {
    print("\(continent) is a continent which contains \(countries) countries")
}

places(continent: "Antarctica", countries: 1)
...
func drunk(number: Int, beverage: String, location: String) {
    print("\(number) bottles of \(beverage) on the \(location)")
}

drunk(number: 99, beverage: "beer", location: "wall")
