...
continents("North America", numberOfCountries: 2)
 ...
 */
func three(beverage: String, numberOfBottles: Int, placeToKeep: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(placeToKeep) wall.")
}

three("Pepsi", numberOfBottles: 20, placeToKeep: "upper")
