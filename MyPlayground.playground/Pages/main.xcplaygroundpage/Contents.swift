...
func contDetails(continent: String, numCountries: Int) {
    print("\(continent) is a continent which contains \(numCountries) countries")
}

contDetails(continent: "Merica", numCountries: 1)
/*: question2
...
func soda(beverage: String, bottles: Int, place: String) {
    print("\(bottles) bottles of \(beverage) on the \(place) wall.")
}

soda(beverage: "coke", bottles: 30, place: "fat gay")
