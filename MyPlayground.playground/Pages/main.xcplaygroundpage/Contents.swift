...
func howManyCountries(continent : String , countries : Int){
    print("\(continent) is a continent which contains \(countries) countries.")
}

howManyCountries(continent: "North America", countries: 3 )
 ...
 */
func threeParam(num : Int, drink : String , color : String){
    print("\(num) bottles of \(drink) on the \(color) wall")
}

threeParam(num: 3, drink: "beer", color: "blue")
