 ...
 */
func continentFunc(continent: String, countries: Int){
    print("\(continent) is a continent which contains \(countries) countries")
}

continentFunc(continent: "North America", countries: 2)
 ...
 */
func bottleFunc(_ beverage: String, _ bottles: Int, _ place: String){
    print("\(bottles) bottles of \(beverage) on the \(place) wall.")
    }

bottleFunc("Whiskey", 22, "Kitchen")
