...
func country(continent: String, number: Int)
{
    print("\(continent) is a continent which contains \(number) countries")
}

country(continent: continent, number: number)
 ...
 */
func stock(name: String, number: Int, location: String)
{
    print("\(number) bottles of \(name) on the \(location) wall")
}

stock(name: "Gin", number: 50, location: "Woodbury")
