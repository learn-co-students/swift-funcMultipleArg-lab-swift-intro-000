...
func example(continent: String, countries: Int) {
    print("\(continent) is a continent which contains \(countries) countries")
}

example(continent: "Africa", countries: 50)
...
func myFunction(beverage: String, bottles: Int, place: String) {
    print("\(bottles) bottles of \(beverage) on the \(place) wall.")
}

myFunction(beverage: "wine", bottles: 3, place: "kitchen")
