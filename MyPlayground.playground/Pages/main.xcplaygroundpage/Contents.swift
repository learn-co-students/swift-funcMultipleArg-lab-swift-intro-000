...
func countriesInContinent(country : Int, continent : String){
    print("\(continent) is a continent which contains \(country) countries")
}
countriesInContinent(country: 2, continent: "North America")
 ...
 */
// write your code here
func numberOfDrinks(beverage: String, number: Int, place: String){
    print("\(number) bottles of \(beverage) on the \(place) wall")
}
numberOfDrinks(beverage: "Vodka", number: 8, place: "baby's")
