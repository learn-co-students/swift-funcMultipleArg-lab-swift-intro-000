 ...
 */
// write your code here
func bottle (bevName: String, numBottles: Int, placeToKeep: String)
{
    print("\(numBottles) bottles of \(bevName) on the \(placeToKeep)")
}

bottle(bevName: "Brooklyn Ale", numBottles: 12, placeToKeep: "refrigerator")
