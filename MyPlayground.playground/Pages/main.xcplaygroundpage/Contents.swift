 ...
 */
func continentSentence(_ continent: String, _ numberOfCountries: String) {
    print("\(continent) is a continent which contains \(numberOfCountries) countries")
}

continentSentence("Europe", "43")
 ...
 */
func bottles( _ beverage: String, _  numberOfBottle: String, _ place: String) {
    print("\(beverage) bottles of \(numberOfBottle) on the \(place) wall.")
}

bottles("coca", "3", "North")
