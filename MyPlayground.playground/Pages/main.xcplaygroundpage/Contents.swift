...
func countCountries(continent:String,country:String)
{
...
func bottleSong(bev:String,quantity:String,place:String)
{
   print("\(quantity) bottles of \(bev) on the \(place)")
}

bottleSong(bev:"beer",quantity:"100",place:"wall")
