 ...
 */
func bottles(beverage: String, location: String, quantity: Int) {
    print("\(quantity) bottles of \(beverage) on the \(location)")
}

bottles(beverage: "beer", location: "wall", quantity: 99)
