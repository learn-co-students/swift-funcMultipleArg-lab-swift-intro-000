...
func continentCountriesCount(continent: String, numberOfCountries: Int) {
    print("\(continent) is a continent which contains \(numberOfCountries) countries")
}

continentCountriesCount("Australia", numberOfCountries: 1)
 ...
 */
// write your code here
func bar(beverage: String, numberOfBottles: Int, storage: String) {
    print("\(beverage) bottles of \(numberOfBottles) on the \(storage) wall.")
}

bar("Blue Moon", numberOfBottles: 10, storage: "Back")
