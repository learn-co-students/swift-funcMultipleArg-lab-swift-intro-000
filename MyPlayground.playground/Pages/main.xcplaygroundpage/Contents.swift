...
func countryContinent(continentName: String, numberOfCountries) {
 ...
 */
func bottlesOfBeer(beverage: String, numberOfBottles: Int, destination: String) {
    print ("\(numberOfBottles) bottles of \(beverage) on the \(destination)" )
}
