...
func something(continent: String, numberOfCountries: Int) {
    print("\(continent) is a continent which contains \(numberOfCountries) countries")
}

something(continent: "TEST", numberOfCountries: 30)
/*: question2
...
func testFucntion(beverage: String, numberOfBottles: Int, location: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(location) wall.")
}

testFucntion(beverage: "Coke", numberOfBottles: 30, location: "West")
