...
func continetAndCountries(continent: String, countries: Int) {
 ...
 */
// write your code here
func bev(beverage: String, numberOfBottles: Int, place: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(place) wall.")
}
bev(beverage: "coke", numberOfBottles: 1, place: "left")
bev(beverage: "cider", numberOfBottles: 1, place: "green")
