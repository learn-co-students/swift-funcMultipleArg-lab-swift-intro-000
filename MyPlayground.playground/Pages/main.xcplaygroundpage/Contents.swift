 ...
 */
func numOfCountries(continent: String, num: Int) {
    print("\(continent) is a continent which contains \(num) countries.")
}
numOfCountries(continent: "Antartica", num: 1)
 ...
 */
func threeParams(_ beverage: String, _ num: Int, _ kept: String) {
    print("\(num) bottles of \(beverage) on the \(kept) wall.")
}
threeParams("beer", 5, "blue")
