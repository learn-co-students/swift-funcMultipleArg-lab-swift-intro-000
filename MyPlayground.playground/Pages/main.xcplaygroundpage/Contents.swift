...
func continent(continent: String, numberOfCountries num: Int) {
    print("\(continent) is a continent which contains \(num) countries")
}

continent(continent: "Test", numberOfCountries: 2989)
/*: question2
...
func beverageOnWall(beverage: String, bottles: Int, place: String) {
    print("\(bottles) bottles of \(beverage) on the \(place).")
}

beverageOnWall(beverage: "beer", bottles: 99, place: "wall")
