...
func numberOfContinents (continent: String, countries: Int) {
    print("\(continent) is a continent which contains \(countries) countries")
}
numberOfContinents(continent: "North America" , countries: 23)
...
drinks(beverage: "Sprite", numberOfBottles: 25, place: "back")
