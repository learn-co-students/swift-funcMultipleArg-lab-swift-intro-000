...
continentCountries(continent: "Asia", countries: 48 )
...
func wineBottles(_ beverage: String, _ nBottles: Int, _ place: String){
    print("\( nBottles) bottles of \(beverage) on the \(place) wall.")
}
wineBottles("wine",25, "front")
