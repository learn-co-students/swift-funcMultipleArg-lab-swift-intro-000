 ...
 */
func countryCounter(continent: String, countries: Int) {
    print("\(continent) is a continent which contains \(countries) countries.");
}

countryCounter(continent: "Africa", countries: 10);
 ...
 */
func song(beverage: String, bottleNum: Int, location: String) {
    print("\(bottleNum) bottles of \(beverage) on the \(location) wall");
}

song(beverage: "beer", bottleNum: 99, location: "yellow");
