...
func cont(continent: String, numOfCountries: Int)
{
...
func storage(_ bev: String, _ numOfBottles : Int, _ location: String)
{
    print ("\(numOfBottles) bottles of \(bev) on the \(location) wall")
}

storage("Beer", 25, "tall")
