...
continentCountries(continent: "Asia", countries: 14)
 ...
 */
func bottlesOnWall(number: Int, type: String, location: String) {
  print("\(number) bottles of \(type) on the \(location).")
}

bottlesOnWall(number: 99, type: "Beer", location: "wall")
