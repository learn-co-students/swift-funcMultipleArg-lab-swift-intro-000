...
func continentCountry(continent: String, number: Int) {
    print("\(continent) is a continent which contains \(number) countries")
}
continentCountry(continent: "Antarctic", number: 0)
 ...
 */
// write your code here
func berlin(beverage: String, number: Int, place: String) {
    print("\(number) bottles of \(beverage) on the \(place) wall.")
}
berlin(beverage: "beer", number: 10, place: "Berlin")
