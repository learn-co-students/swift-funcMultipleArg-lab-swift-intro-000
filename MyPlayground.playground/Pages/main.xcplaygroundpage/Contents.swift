...
func numberOfCountriesInContinent(_ continentName: String, _ numberOfCountries: Int) {
    print("\(continentName) is a continent which contains \(numberOfCountries) countries")
}

numberOfCountriesInContinent("North America", 23)
 ...
 */
// write your code here
func bottlesOnTheWall(beverage: String, numberBottles: Int, place: String) {
    print("\(numberBottles) bottles of \(beverage) on the \(place) wall.")
}

bottlesOnTheWall(beverage: "Beer", numberBottles: 99, place: "front")
