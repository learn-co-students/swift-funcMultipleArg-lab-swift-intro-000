 ...
 */
func continentFacts(continent: String, countries: Int) {
 ...
 */
func annoyingSong(number: Int, drink: String, place: String) {
    
    print("\(number) bottles of \(drink) on the \(place).")
    
}


annoyingSong(number: 99, drink: "beer", place: "wall")
