...
func countriesInContinent(continent: String, noCountries: Int) {
 ...
 */
// write your code here
func bevs(beverage: String, noBottles: Int, wall: String) {
    print("\(noBottles) bottles of \(beverage) on the \(wall) wall.")
}
