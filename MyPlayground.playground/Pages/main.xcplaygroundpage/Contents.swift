...
func describeContinent(name: String, number: Int) {
 ...
 */
// write your code here
func bottlesOnWall(beverage: String, numberOfBottles: String, location: String) {
    print("\(beverage) bottles of \(numberOfBottles) on the \(location) wall.")
}
