...
func showStatement(continentName: String, numberOfCountries: Int)
{
    print ("\(continentName) is a continent which contains \(numberOfCountries) countries.")
}

showStatement(continentName: "Asia", numberOfCountries: 7)
 ...
 */
// write your code here
func storage (_ beverage: String, _ numberOfBottles: Int, _ storageType: String )
{
    print("\(numberOfBottles) bottles of \(beverage) on the \(storageType).")
}

storage("Beer", 7, "wall")
storage("whiskey", 72, "fridge")
storage("Beer",  4, "bar")
