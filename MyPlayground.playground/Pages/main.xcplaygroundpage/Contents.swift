 ...
 */
func continentalDescription(continent: String,countries: Int){
...
continentalDescription(continent: continent, countries: countries)
 ...
 */
func waitressMode(numberOfBottles: Int, beverage: String, wall: String){
