...
func continents(continent: String, num: Int){
    print("\(continent) is a continent which contains \(num) countries")
}
continents(continent:"Africa", num:55)
...
func q4(_ bev: String,_ count: Int,_ loc: String){
    print("\(count) bottles of \(bev) on the \(loc) wall")
}
