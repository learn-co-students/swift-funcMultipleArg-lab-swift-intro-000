 ...
 */
func countriesIn(continent: String, countries: Int){
    print("\(continent) is a continent which contains \(countries) countries.")
}

countriesIn(continent: "Antarctica", countries: 0)
 ...
 */
func sing(beverage: String, container: String, amount: Int){
    print("\(amount) \(container) of \(beverage) on the wall.")
}

sing(beverage: "beer", container: "bottles", amount: 99 )
