 ...
 */
func countryCounter(continent: String, numOfCountries: Int) {
    print("\(continent) is a continent which contains \(numOfCountries) countries.")
}

countryCounter(continent: "Africa", numOfCountries: 54)
 ...
 */
func barSong(beverage: String, numBottlesOfBeverage: Int, bottleStorage: String) {
    print("\(numBottlesOfBeverage) bottles of \(beverage) on the \(bottleStorage)")
}

barSong(beverage: "Rum", numBottlesOfBeverage: 34, bottleStorage: "glass counter")
