 ...
 */
func Kontinentum(continent: String, countries: Int){
    print("\(continent) is a continent which contains \(countries) countries")
}

Kontinentum(continent: "Boi", countries: 55)
 ...
 */
func bottlewtf(numbr1: String, numbr2:String, numbr3: Float){
    print("\(numbr1) bottles of \(numbr2) on the \(numbr3) wall.")
}

bottlewtf(numbr1: "dafuq", numbr2: "wats this?", numbr3: 0.012424143324)
