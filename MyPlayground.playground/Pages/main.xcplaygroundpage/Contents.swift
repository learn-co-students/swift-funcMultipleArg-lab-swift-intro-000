...
func world(continent: String, numCountries: Int) {
 ...
 */
// write your code here
func drunk(_ beverage: String, numBottles: Int, placement: String) {
    print("\(beverage) bottles of \(numBottles) on the \(placement) wall")
}
let placement = "South"

drunk("The Long Island",numBottles: 13, placement: placement)
