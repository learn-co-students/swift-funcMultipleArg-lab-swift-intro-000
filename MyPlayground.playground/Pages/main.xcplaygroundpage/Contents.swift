...
countriesInContinent(continent: "Australia", numberOfCountries: 1)
countriesInContinent(continent: "Europe", numberOfCountries: 53)
 ...
 */
func beverageFunc(beverage: String, numberOfBottles: Int, place: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(place) wall.")
}

beverageFunc(beverage: "beer", numberOfBottles: 4, place: "north")
