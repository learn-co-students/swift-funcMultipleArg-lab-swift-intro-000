 ...
 */
func countryAmount(continent: String, countries: Int) {
    print("\(continent) is a continent which contains \(countries) countries")
}
countryAmount(continent: "Austrailia", countries: 3)
 ...
 */
func printBevsOnWall(_ beverage: String, _ bottles: Int, _ place: String) {
    print("\(bottles) bottle of \(beverage) on the \(place) wall")
}
printBevsOnWall("beer", 99, "Berlin")
