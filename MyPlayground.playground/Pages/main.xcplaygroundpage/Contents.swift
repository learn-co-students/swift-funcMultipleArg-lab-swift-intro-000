 ...
 */
func sentence(continent: String, numberOfCountries: Int) {
 ...
 */
func otherSentence(_ beverage: String, _ numberOfBottles: Int,_ placeOfBottles: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(placeOfBottles) wall")
}// write your code here

otherSentence("Beer",99,"Blank")
