 ...
 */
func continents(con: String, countries: Int) {
    print("\(con) is a continent which contains \(countries)")
}

continents(con: "South American", countries: 50)
 ...
 */
func three(beverage: String, bottles: Int, place: String){
    print("\(bottles) bottles of \(beverage) on the \(place)")
}

three(beverage: "beer", bottles: 10, place: "store")
