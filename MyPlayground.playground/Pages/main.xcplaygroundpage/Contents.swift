 ...
 */
func continents(continent: String, amountOfCountries: Int) {
    print("\(continent) is a continent which contains \(amountOfCountries) countries")
 ...
 */
func beverages(beverage: String, numberOfBottles: Int, locationOfBottles: String) {
