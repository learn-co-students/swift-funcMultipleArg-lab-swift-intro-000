...
countries(continent: "Africa", numberOfCountries: 10)
 ...
 */
// write your code here
func drinkUp(beverage: String, numberOfBottles: Int, place: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(place) wall.")
}

drinkUp(beverage: "Coke", numberOfBottles: 10, place: "Arcadia")
