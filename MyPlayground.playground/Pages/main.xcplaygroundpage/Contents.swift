...
continentCountries(continent: "North America", numberOfCountries: 23)
 ...
 */
func bottleThings(beverage: String, beverageAmount: Int, beverageStorage: String) {
    print("\(beverageAmount) bottles of \(beverage) on the \(beverageStorage) wall.")
    
}

bottleThings(beverage: "Coke", beverageAmount: 3, beverageStorage: "Left")
