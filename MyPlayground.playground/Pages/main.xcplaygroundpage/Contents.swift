...
countriesInContinent(continent: "Africa", countries: 54)
 ...
 */
func folkSong(bottles: Int, beverage: String, location: String){
    print("\(bottles) bottles of \(beverage) on the \(location) wall.")
}

folkSong(bottles: 33, beverage: "beer", location: "kitchen")
