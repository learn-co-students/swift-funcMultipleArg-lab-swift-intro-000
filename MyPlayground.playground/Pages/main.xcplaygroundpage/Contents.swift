 ...
 */
func cont(continent: String, numCountries: Int) {
    print("\(continent) is a continent which contains \(numCountries) countries")
}

cont(continent: "Asia", numCountries: 5)
 ...
 */
func printBev(_ beverage: String, _ numBottles: Int, _ place: String) {
    print("\(numBottles) bottles of \(beverage) on the \(place) wall.")
}

printBev("beer", 12, "store")
