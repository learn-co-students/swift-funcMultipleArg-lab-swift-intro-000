 ...
 */
func display(continent: String, withCountries countries: Int) {
 ...
 */
func store(_ bottlesCount: Int, bottlesOf beverage: String, inA place: String) {
    print("\(bottlesCount) bottles of \(beverage) on the \(place) wall")
}
store(20, bottlesOf: "beer", inA: "pantry")
