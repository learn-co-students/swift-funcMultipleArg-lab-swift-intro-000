 ...
 */
func mapQuest( continent: String, numOfCountries: Int){
	print("\(continent) is a continent which contains \(numOfCountries) countries")
}

mapQuest(continent: "North America", numOfCountries: 3)
 ...
 */
func bottleCount( beverage: String, numOfBottles: Int, place: String){
	print("\(numOfBottles) bottles of \(beverage) on the \(place) wall")
}

bottleCount(beverage: "Mt. Dew", numOfBottles: 69, place: "Garage")
