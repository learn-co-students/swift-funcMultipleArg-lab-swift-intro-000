 ...
 */
func countries(continent: String, countries: Int) {
    print("\(continent) is a continent which contains \(countries) countries.")
}

countries(continent: "North America", countries: 3)
 ...
 */
func bottles(beverage: String, numberOfBottles: Int, storage: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(storage) wall.")
}

bottles(beverage: "Whiskey", numberOfBottles: 4, storage: "Basement")
