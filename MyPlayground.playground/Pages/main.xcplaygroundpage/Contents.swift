 ...
 */
func continentCountryPrinter(continent: String, country: Int) {
    print("\(continent) is a continent which contains \(country) countries.")
}

continentCountryPrinter(continent: "North America", country: 3)
 ...
 */
func p3(beverage: String, numOfBottles: Int, place: String) {
    print("\(numOfBottles) bottles of \(beverage) on the \(place) wall.")
}

p3(beverage: "beer", numOfBottles: 99, place: "blue")
