...
continentDescription(continent: "Europe", numberOfCountries: 21)
 ...
 */
// write your code here
func bottlesOfBeer(numberOfBottles: Int, beverage: String, place: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(place)")
}

bottlesOfBeer(numberOfBottles: 12, beverage: "wine", place: "something???")
