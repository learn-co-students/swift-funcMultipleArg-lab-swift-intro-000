...
func ContinentInfo(name: String, number: Int){
    print("\(name) is a continent which contains \(number) countries")
}
let Continent = "Africa"
let NumOfCountries = 54
print(ContinentInfo(name: Continent, number: NumOfCountries))
 ...
 */
// write your code here
func BeverageInfo (name: String, number: Int, place: String){
