 ...
 */
func number1(continent: String, numberCountries: Int) {
    print ("\(continent) is a continent which contains \(numberCountries) countries.")
}

number1(continent: "Asia", numberCountries: 455)
 ...
 */
func bottles(beverage: String, bottles: Int, place: String) {
    print("\(bottles) bottles of \(beverage) on the \(place) wall.")
}

bottles(beverage: "alcohol", bottles: 33, place: "front")
