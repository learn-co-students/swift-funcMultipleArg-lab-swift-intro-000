 ...
 */
func continentCounter(continent: String, numberOfCountries: Int) {
 ...
 */
func drinkHolderCounter(beverage: String, amount: Int, room: String) {
    print("\(amount) bottles of \(beverage) on the \(room) wall.")
}

drinkHolderCounter(beverage: "gin", amount: 4, room: "kitchen")
