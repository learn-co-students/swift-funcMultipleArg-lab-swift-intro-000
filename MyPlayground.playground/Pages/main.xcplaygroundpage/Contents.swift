 ...
 */
func ContinentCountry(continent: String, countries: Int) {
    print("\(continent) is a continent which contains \(countries) countries")
}

ContinentCountry(continent: "North America", countries: 23)
 ...
 */
func wallKombucha(bottles: Int, drink: String, place: String) {
    print("There are \(bottles) bottles of \(drink) on the \(place) wall.")
}
wallKombucha(bottles: 15, drink: "kombucha", place: "cellar")
