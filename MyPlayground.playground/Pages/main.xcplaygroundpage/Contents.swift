 ...
 */
func continentFacts(name: String, countries: Int) {
    print("\(name) is a continent which contains \(countries) countries")
}

continentFacts(name: "North America", countries: 3)
 ...
 */
func beverageFun(name: String, number: Int, location: String) {
    print("\(number) bottles of \(name) on the \(location) wall.")
}

beverageFun(name: "beer", number: 99, location: "Berlin")
