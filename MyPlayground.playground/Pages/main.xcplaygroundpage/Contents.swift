...
numberOfCountries(continent: "North America", countries: 20)
 ...
 */
// write your code here
func threeArguments(beverage: String, bottles: Int, storage: String) {
    print("\(bottles) bottles of \(beverage) on the \(storage) wall.")
}
threeArguments(beverage: "Soda", bottles: 20, storage: "closet")
