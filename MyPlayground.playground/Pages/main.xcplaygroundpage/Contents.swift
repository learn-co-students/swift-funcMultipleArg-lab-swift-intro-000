 ...
 */
func contCountries(continent: String, numberOfCountries: Int) {
    print ("\(continent) is a continent which contains \(numberOfCountries) countries.")
}
contCountries(continent: "North America", numberOfCountries: 2)
 ...
 */
func bottlesOnWall(number: Int, beverage: String, place: String) {
    print ("\(number) bottles of \(beverage) on the \(place) wall.")
}
bottlesOnWall(number: 50, beverage: "Dr. Pepper", place: "kitchen")
