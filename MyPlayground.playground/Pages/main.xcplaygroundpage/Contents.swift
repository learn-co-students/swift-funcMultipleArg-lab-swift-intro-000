...
func noOfContries(it continent: String, has countries: Int){
    
    print("\(continent) is a continent which contains \(countries) countries")
}

noOfContries(it: "Asia", has: 5)
/*: question2
...
func three(beverages: String, number: Int, wal: String){
    print("\(beverages) bottles of \(number) on the \(wal) wall.")
}

three(beverages: "Colla", number: 66, wal:"back")
