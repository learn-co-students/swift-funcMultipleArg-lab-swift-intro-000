 ...
 */
func continentWitCountries (continent: String, countries: Int) {
        print("\(continent) is a continent wich contains \(countries) countries.")
}

continentWitCountries(continent: "North America", countries: 23)
 ...
 */
func someBeverage (_ beverage: String,_ numberOfBottles: Int,_ place: String){
    print("\(numberOfBottles) bottles of \(beverage) on the \(place)")
}

someBeverage("wine", 10, "shelf")
