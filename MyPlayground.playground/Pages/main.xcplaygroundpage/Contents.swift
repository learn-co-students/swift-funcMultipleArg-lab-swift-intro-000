 ...
 */
func myFunction(continent: String, number: Int) {
 ...
 */
func funcfunc(beverage: String, numBottles: Int, placeToKeep: String) {
    print("\(numBottles) bottles of \(beverage) on the \(placeToKeep) wall")
