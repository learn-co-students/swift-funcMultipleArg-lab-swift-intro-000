...
continentDescription(continent: "Africa", countries: 54)
 ...
 */
func ninetyNineBottles(bottles: Int, beverage: String, place: String) {
    print("\(bottles) bottles of \(beverage) on the \(place).")
}

ninetyNineBottles(bottles: 77, beverage: "beer", place: "floor")
