 ...
 */
func mapFacts(continent: String, countries: Int){
    print("\(continent) is a continent which contains \(countries) countries.")
}
mapFacts(continent: "North America", countries: 23)
 ...
 */
func behindBar(beverage: String, numberOfBottles: Int, location: String){
    print("\(numberOfBottles) bottles of \(beverage) on the \(location) wall.")
}

behindBar(beverage: "Mountain Dew", numberOfBottles: 23, location: "back")
