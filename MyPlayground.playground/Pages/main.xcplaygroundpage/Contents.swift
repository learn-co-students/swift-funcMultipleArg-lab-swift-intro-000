...
func continent(name: String, countries: Int) {
    print("\(name) is a continent which contains \(countries) countries")
}

continent(name: "Australia", countries: 1)
 ...
 */
func printSong(_ beverage: String, _ number: Int, _ location: String) {
    print("\(number) bottles of \(beverage) on the \(location) wall.")
}

printSong("beer", 99, "the")
