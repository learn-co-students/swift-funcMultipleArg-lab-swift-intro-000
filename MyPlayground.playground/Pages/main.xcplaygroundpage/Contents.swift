...
numberOfCountries(continent: "Europe", countries: 10000)
...
func bottlesOnTheWall (beverage: String, number: Int, place: String){
    print ("\(number) bottles of \(beverage) on the \(place) wall.")
    
}

bottlesOnTheWall(beverage: "wine", number: 99, place: "stripclub")
