...
func howMany (continent: String, countries:Int) {
    print (" \(continent) is a continent which contains \(countries) countries.")
}
howMany(continent:"Asia", countries: 48)
 ...
 */
// write your code here
func liquorShop (_ quantity:Int,_ type:String,_ location:String) {
    print (" \(quantity) bottles of \(type) on the \(location) wall.")
}
liquorShop(11, "red wine", "left")
