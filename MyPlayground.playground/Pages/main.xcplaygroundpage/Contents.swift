...
func worldShit(continent: String, number: String) {
    print("\(continent) is a continent which contains \(number) countries.")
}

worldShit(continent: "Asia", number: "ten")
 ...
 */
// write your code here
func song(bottle: Int, drink: String, rack: String){
    print("\(bottle) bottles of \(drink) on the \(rack) wall.")
}

song(bottle: 99, drink: "beer", rack: "wooden")
