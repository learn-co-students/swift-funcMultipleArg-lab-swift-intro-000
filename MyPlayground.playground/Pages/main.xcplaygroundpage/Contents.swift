...
func continentsAndCountries(continent: String, countries: Int) -> String {
    return "\(continent) is a continent which contains \(countries) countries";
}

continentsAndCountries(continent: "Australia", countries: 1);
/*: question2
...
func myFunc(beverage: String, numberOfBottles: Int, place: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(place) wall.");
}

myFunc(beverage: "Milk", numberOfBottles: 3, place: "Under");
